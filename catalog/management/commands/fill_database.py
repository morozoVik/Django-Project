...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Создаем продукты
        products_data = [
            {'name': 'Плагин для рассылок', 'description': 'Плагин для email рассылок', 'price': 2999.99,
             'category': 'Плагины'},
            {'name': 'Плагин для SEO', 'description': 'Плагин для SEO оптимизации', 'price': 5999.00,
             'category': 'Плагины'},
            {'name': 'ТГ Бот уведомлений', 'description': 'Бот для уведомлений в Telegram', 'price': 4999.50,
             'category': 'Телеграм боты'},
            {'name': 'Бот для заказов', 'description': 'Бот для автоматизации заказов', 'price': 8999.00,
             'category': 'Телеграм боты'},
            {'name': 'Интернет-магазин', 'description': 'Готовый интернет-магазин на Django', 'price': 14999.00,
             'category': 'Веб-приложения'},
            {'name': 'Корпоративный портал', 'description': 'Веб-приложение портала', 'price': 24999.00,
             'category': 'Веб-приложения'},
        ]
